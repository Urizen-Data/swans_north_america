...
| `powerbi/swans_north_america.pbix` | Готовый дашборд Power BI: карта, динамика, сезонность, блок регрессий |
| `data/data_seasonal_enriched.csv` | Итоговый датасет исследовательского анализа: наблюдения с температурой, плотностью, сезонами, периодами и кластерами |
| `data/fact_observations.csv` | Основная таблица фактов для Power BI |
| `data/fact_regression.csv` | Результаты регрессий по кластерам, видам, сезонам и факторам |
| `data/dim_month.csv` | Справочник месяцев и временных периодов |
| `data/dim_species.csv` | Справочник видов лебедей |
| `data/dim_season.csv` | Справочник сезонов |
| `data/dim_location.csv` | Справочник координатных ячеек и регионов |
| `data/dim_cluster.csv` | Справочник географических кластеров |
| `data/` | Папка со всеми датасетами и справочниками |
